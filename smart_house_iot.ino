...
#define AIO_USERNAME    "Henos"  // adafruit  username
#define AIO_KEY         "aio_eWMN085y8WORZnJnOqwrL7clLTgt" //aio key

WiFiClient client; 
unsigned long myChannelNumber =2497231;  //thinkspeak channel number 
const char * myWriteAPIKey ="ZC6HM0FPV3RGMYEX";  // thinkspeak api key
Adafruit_MQTT_Client mqtt(&client, AIO_SERVER, AIO_SERVERPORT, AIO_USERNAME, AIO_KEY);
Adafruit_MQTT_Publish lightIntensityFeed = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/light-sensor");
...
void loop() {
  ...
  ThingSpeak.writeField( 2497231, 1, lightIntensity,"ZC6HM0FPV3RGMYEX");  // channel number and writeapikey
